...
<c:choose>
	<c:when test="${param.isAdding == true}"></c:when>
	<c:otherwise><h2>Edit Product</h2></c:otherwise>
</c:choose>

<div>
  <button id="addUserButton" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addUserForm">Add Product</button>
</div>
